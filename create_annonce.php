...
<head>
    ...
    <title>Formulaire d'inscription à une newsletter</title>
...
<section class="container py-5">
    <div class="row justify-content-center">
        ...
        <form action="create_annonce_post.php" method="POST" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="title_annonce">Titre de votre annonce</label>
                    <input type="text" class="form-control" name="title" id="title_annonce" placeholder="...">
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" name="address" id="address_annonce" placeholder="Adresse complète + code postal inclus" class="col-md-12">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-12">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="price_annonce" name="price" min ="1" max="5000" required>
                </div>
            ...
            <input type="submit" class="btn btn-primary col-6 offset-md-3" name ="submit" value="Créer votre annnonce"/>
        </form>
        </div>
</section>
